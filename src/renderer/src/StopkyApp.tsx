...
import { Button, Label, Switch, Table, Tabs } from '@heroui/react'
...
function StopkyPruh({
  ...
  return (
    ...
    >
      ...
      <Btn variant="tertiary" onClick={onVratit} disabled={akt.klik.length === 0} style={{ height: 44 }}>
        Vrátit poslední
      </Btn>
